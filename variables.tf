...
variable "cloud_monitoring_instance_crn" {
  ...
  validation {
    ...
    error_message = "The provided Monitoring instance CRN in the input 'cloud_monitoring_instance_crn' in not valid. Please also ensure it is in the same region specified the 'input' region input."
  }
}
